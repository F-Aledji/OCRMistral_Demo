...
0. **Anzahl Positionen**: Zähle alle Positionen auch Splitteile (Kennzeichne splits bitte) damit du einen Überblick gewinnst wie viele Positionen auf jeden Fall extrahiert werden müssen.
...
## POSITIONEN
** Anzahl Positionen: [Anzahl Insgesamt] **
---
**Pos**: [Nummer]
